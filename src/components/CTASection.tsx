    ...
    <section id="contact" ref={ref} className="section-padding bg-background">
      <div className="container-custom px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="relative overflow-hidden rounded-2xl p-8 sm:p-10 md:p-14 border border-white/10"
          style={{
        ...
        >
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8 lg:gap-12">
            ...
            <div className="flex-1 lg:max-w-2xl">
              ...
              >
                Partner with RenoXentia to design, develop, and deploy high-performance digital systems tailored to your business needs. From custom applications to intelligent automation, we help you turn ideas into reliable technology.
              </motion.p>
            ...
            <motion.div
              ...
              className="lg:flex-shrink-0 lg:self-center"
            >
      ...
      rounded-xl px-8 py-4 font-medium 
