...
import { Code, Smartphone, Layout, MessageSquare, ShoppingCart, Server } from "lucide-react";
...
const services = [
  ...
  },
  {
    icon: Server,
    title: "Enterprise IT",
    description: "Compliant, high-security IT infrastructure designed for government bodies and large corporations.",
  },
];
...
export const ServicesSection = () => {
  ...
  return (
    <section id="services" ref={ref} className="bg-background section-padding">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => (
            <motion.div
              ...
              className="group card-premium p-6 hover:border-teal-light/30 transition-all duration-300"
            >
              <div className="w-12 h-12 rounded-xl bg-teal-light/10 border border-teal-light/20 flex items-center justify-center mb-5 group-hover:bg-teal-light/20 transition-colors duration-300">
